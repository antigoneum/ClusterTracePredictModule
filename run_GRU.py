...
import wandb
import time
run_project_name = "GRU_25CTPF_pre1_diff"
run_notes = "GRU"
run_tags = ["GRU"]
sweep_name = "GRU_25CTPF_pre1_diff"
...
sweep_config = {
    ...
    "parameters": {
        ...
        "seq_len": {"max": 128, "min": 8, "distribution": "int_uniform"},  #历史数据长度
        ...
        "gru_layer": {"max": 3, "min": 1 , "distribution": "int_uniform"},  #GRU层数
        "gru_hidden_size": {"max": 128, "min": 8 , "distribution": "int_uniform"},  #GRU隐藏层宽度
        "gru_mlp_layers": {"max": 3, "min": 1 , "distribution": "int_uniform"},  #GRUMLP层数
        "gru_mlp_size": {"max": 128, "min": 8 , "distribution": "int_uniform"},  #GRUMLP层的宽度
    }
}
